...
copy_file "/usr/bin/ld.bfd"
copy_file "/usr/bin/ld.gold"
...
copy_file "/usr/bin/fpc-depends"
copy_file "/usr/bin/fpclasschart"
copy_file "/usr/bin/fpcmake"
copy_file "/usr/bin/fpcres"
copy_file "/usr/bin/fpcsubst"
